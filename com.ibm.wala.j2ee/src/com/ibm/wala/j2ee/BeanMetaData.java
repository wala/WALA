 ...
 * 
 * TODO: this currently can represent either a session or entity bean. Introduce
 * classes to distinguish between them.
 * 
 * @author sfink
 */
public interface BeanMetaData {
   ...
   * 
   * @return Set of IFields
   */
  Collection<FieldReference> getCMPFields();

  /**
   * Return a Set of container managed relationship (cmr) fields, as
   * FieldReference objects.
   * 
   * @return Set of cmrs
   */
  ...
  /**
   * Return a Map of the container created getter methods, as MethodReference
   * objects, and the field that the method references.
   * 
  ...
  /**
   * Return a Map of the container created setter methods, as MethodReference
   * objects, and the field that the method references.
   * 
  ...
  /**
   * Return a Map of container created getter methods for CMRs, as a mapping
   * from MethodReference->FieldReference. The container is responsible for
   * creating a getter method for each container managed relationship.
   */
  Map<MethodReference, FieldReference> getCMRGetters();

  /**
   * Return a Map of container created setter methods for CMRs, as a mapping
   * from MethodReference->FieldReference. The container is responsible for
   * creating a setter method for each container managed relationship.
   */
   ...
   * 
   * @return true if bean is container manged.
   */
   ...
   * 
   * @return true if bean is a container manged entity.
   */
  ...
  /**
   * Return the Set of container created finder methods, as Method reference
   * objects.
   * 
