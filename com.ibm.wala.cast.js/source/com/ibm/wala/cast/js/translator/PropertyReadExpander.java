...
public class PropertyReadExpander extends CAstRewriter<PropertyReadExpander.RewriteContext> {
    ...
    return
      Ast.makeNode(CAstNode.BLOCK_EXPR,
        Ast.makeNode(CAstNode.DECL_STMT,
          Ast.makeConstant(new CAstSymbolImpl(receiverTemp)),
	  receiver),
			       ...
			       RewriteContext context) 
  {
    ...
    return
	  ...
	  receiver),
	Ast.makeNode(CAstNode.DECL_STMT,
	  Ast.makeConstant(new CAstSymbolImpl(elementTemp)),
	  element),
	Ast.makeNode(CAstNode.LOOP,
	  Ast.makeNode(CAstNode.UNARY_EXPR,
	    CAstOperator.OP_NOT,
			       ...
			       Map<CAstNode, CAstNode> nodeMap) 
  {
	...
	CAstNode copy = Ast.makeNode(CAstNode.BLOCK_EXPR,
	  Ast.makeNode(CAstNode.DECL_STMT,
	    Ast.makeConstant(new CAstSymbolImpl(temp1, true)),
	    lval),
	  rval,
	  Ast.makeNode(CAstNode.DECL_STMT,
	    Ast.makeConstant(new CAstSymbolImpl(temp2, true)),
