...
application {
  ...
  dependencies {
    coreResources(project(":com.ibm.wala.core"))
    smokeMainExtraPathElements(project(":com.ibm.wala.cast"))
    smokeMainExtraPathElements(project(":com.ibm.wala.core"))
    smokeMainExtraPathElements(project(":com.ibm.wala.util"))
    implementation(project(":com.ibm.wala.cast:cast"))
    implementation(project(":com.ibm.wala.cast:xlator_test"))
    xlatorTestDebugSharedLibraryConfig(project(":com.ibm.wala.cast:xlator_test"))
    xlatorTestReleaseSharedLibraryConfig(project(":com.ibm.wala.cast:xlator_test"))
  }
