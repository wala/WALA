...
public class RegexSwitch {
  ...
  protected Object doSwitch(int classifierID, EObject theEObject) {
    switch (classifierID) {
      case RegexPackage.EPATTERN: {
        EPattern ePattern = (EPattern)theEObject;
        Object result = caseEPattern(ePattern);
  ...
  /**
   * Returns the result of interpretting the object as an instance of '<em>EPattern</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpretting the object as an instance of '<em>EPattern</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public Object caseEPattern(EPattern object) {
    return null;
  }
