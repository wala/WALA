...
/**
 * This interface represents policies for selecting a class to
 * allocate at a given new site.  The most obvious such policy would
 * be to look at the relevant class hierarchy and lookup the
 * appropriate class based on the type reference at the new site.
 * However, other policies are possible for purposes such as providing
 * an abstraction of unanalyzed libraries or specialized J2EE
 * functionality. 
 *
...
public interface ClassTargetSelector {
  ...
  /**
   * Given a calling node and a new site, return the type to be
   * allocated.
   *
