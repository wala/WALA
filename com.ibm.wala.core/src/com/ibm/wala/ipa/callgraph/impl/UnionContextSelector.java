 ...
 *
 *  The returned Context contains the ContextKeys from A and B. If for a given key a value is
 *  generated by A as well as B the value generated by A has the precedence.
 *
 *  As the UnionContextSelector optionally returns a DelegatingContext it cannot be used to 
