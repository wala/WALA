...
public interface ILiveObjectAnalysis {
  ...
  /**
   * @param allocMethod
   *          a method which holds an allocation site
   * @param allocPC
   *          bytecode index of allocation site
   * @param m
   *          method in question
   * @param instructionIndex
   *          index of an instruction in SSA IR. in m. if -1, it is interpreted as a
   *          wildcard meaning "any statement"
   * @throws WalaException
   * @returns true if an object allocated at the allocation site
   *          &lt;allocMethod,allocPC> may be live immediately after the statement <m,instructionIndex>
   */
   ...
   * @param m
   *          method in question
   * @param instructionIndices
   *          indices of instructions in SSA IR. 
   * @returns true if an object allocated at the allocation site
   *          &lt;allocMethod,allocPC> may be live immediately after the statement <m,instructionIndex> for any
   *          instructionIndex in the set
   */
